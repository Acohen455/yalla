...
import com.yalla.yalla_backend.DAOs.UserDAO;
import com.yalla.yalla_backend.DAOs.VendorDAO;
...
public class WebSecurityConfig {
    ...
    @Autowired
    public WebSecurityConfig(UserDAO userDAO, VendorDAO vendorDAO, JwtTokenFilter jwtTokenFilter, AuthenticationManagerBuilder authenticationManagerBuilder) {
